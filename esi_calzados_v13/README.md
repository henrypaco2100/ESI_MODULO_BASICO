...
## Producción en Proceso visible en Balance (WIP)

Desde 13.0.3.1.0, cuando el usuario utiliza el botón estándar **Producir** de Odoo 13,
el módulo toma las cantidades de materias primas registradas como consumidas y crea un
asiento provisional:

- Débito: **Producción en Proceso** (ej. 154000)
- Crédito: **Cuenta de valoración de la materia prima** (ej. 153000)

Esto permite que una OF en estado **En progreso / Por cerrar** aparezca en el Balance
como producción en proceso. Al **Publicar inventario / Marcar como hecho**, el asiento
provisional se revierte automáticamente y Odoo genera la valoración definitiva estándar:
Materia Prima -> WIP -> Producto Terminado. De esta forma no se duplica el costo.

Los destajos confirmados continúan cargando directamente a Producción en Proceso, por lo
que el saldo WIP puede incluir materiales + destajos mientras la OF está abierta.
