...
class SdStockPickingRecepcionConsignacion1(models.Model):
    ...
    #     """prueba imprimir"""
    #     return self.env.ref('esi_sd_comprobantes_contable.sd_action_account_move_comprobantes').sudo().report_action(self)
    ...
    def crear_archivo_adjunto(self):
        pdf = self.env.ref('esi_sd_comprobantes_contable.sd_action_account_move_comprobantes').render_qweb_pdf(self.ids)
