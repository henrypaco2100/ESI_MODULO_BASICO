# esi_sd_comprobantes_contable - actualización ESI 2026-09-01
...
- CTA Flujo usa `account.move.line.esi_cash_flow_id` de `esi_bi_financial_pdf_reports`.
- Analítica usa el campo estándar `account.move.line.analytic_account_id` de Odoo 13.
- Dependencias explícitas con `esi_bi_financial_pdf_reports` y `esi_bi_financial_excel_reports`.
